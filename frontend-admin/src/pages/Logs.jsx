...
export default function Logs() {
  ...
  const columns = [
    ...
    { title: '操作', dataIndex: 'action', render: a => <Tag color={actionColors[a] || 'default'}>{actionMap[a] || a}</Tag>, width: 140 },
    { title: '对象类型', dataIndex: 'entity_type', render: t => entityMap[t] || t, width: 90 },
